...
const Footer = () => {
  return (
    <footer className="bg-navy-900 bg-blue-950 text-white py-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          {/* Business column */}
          <div className="md:col-span-1">
            <h2 className="text-orange-500 font-semibold text-lg mb-4">START A BUSINESS</h2>
          ...
          {/* Government column */}
          <div className="md:col-span-1">
            <h2 className="text-orange-500 font-semibold text-lg mb-4">GOVERNMENT REGISTRATION</h2>
            <ul className="space-y-3">
          ...
          {/* Compliance column */}
          <div className="md:col-span-1">
            <h2 className="text-orange-500 font-semibold text-lg mb-4">COMPLIANCE & TAX</h2>
            <ul className="space-y-3">
          ...
          {/* BIS column */}
          <div className="md:col-span-1">
            <h2 className="text-orange-500 font-semibold text-lg mb-4">BIS & CDSCO</h2>
            <ul className="space-y-3">
        ...
        <div className="flex justify-center mt-12 mb-6">
          <button 
            className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center text-white hover:bg-orange-600"
